...
<body>
	...
	<a id="n" href="input.php"><button>Tambah Transportasi</button></a>
	<hr>
	<?php 
		//koneksi
		...
		while ($data = mysqli_fetch_array($hasil)) {
		 	...
		 	echo "<td width='10%'>",$data['id_tipe_transportasi'],"</td>";
		 	echo "<td width='5%'>","<a href=\"update.php?id=$data[id_transportasi]\">Edit </a>","</td>";
	 		echo "<td width='5%'>","<a href=\"delete.php?id=$data[id_transportasi]\">Delete</a></td></tr></table>";
		 } 
	 ?>
